...
const dropdownGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'People-Powered Tourism Guiding Principles', to: '/guiding-principles' },
      { label: 'People-Powered Tourism Global Alignment', to: '/globally-aligned-locally-grounded' },
      { label: 'People-Powered Tourism Strategic Pillars', to: '/people-powered-tourism-strategic-pillars' },
      { label: 'People-Powered Tourism Development Models', to: '/people-powered-tourism-development-models' },
      { label: 'People-Powered Tourism Operational Platforms', to: '/people-powered-tourism-operational-platforms' },
      { label: 'People-Powered Tourism Outcomes', to: '/people-powered-tourism-outcomes' },
      { label: 'People-Powered Tourism Ecosystem Indicators', to: '/people-powered-tourism-ecosystem-indicators' },
