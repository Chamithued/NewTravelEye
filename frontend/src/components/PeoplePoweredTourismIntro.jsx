    ...
    <section className="w-full bg-white px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <blockquote className="mx-auto mt-8 max-w-3xl border-l-4 border-[#1F4F93] bg-[#DFE7F3] px-5 py-5 text-left text-base font-semibold italic leading-8 text-[#1f4f93] shadow-sm sm:text-lg">
